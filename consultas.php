...
<head>
  ...
  <title>Query of Participant</title>
</head>
...
<body>
  <div class="row">
    ...
    <a href="consultas.php" class="right header-opt" style=" color: #FAFAFA;">Participants</a>
  ...
  <div class="row">
    ...
    <div class="col hide-on-small-only m2 l2">
      <ul class="section table-of-contents fixed" id="side">
        <li><a href="#Tournament">Add Participants</a></li>
        <li><a href="#Judge">Participants</a></li>
      </ul>
    </div>
  </div>
